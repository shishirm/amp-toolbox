...
exports.HeroImageIsDefined = void 0;
const rule_1 = require("../rule");
const PreloadHeroImage_1 = __importDefault(require("@ampproject/toolbox-optimizer/lib/transformers/PreloadHeroImage"));
/**
 ...
 * and a relevant size.
 */
class HeroImageIsDefined extends rule_1.Rule {
    run({ $ }) {
        ...
        const heroCandidates = new PreloadHeroImage_1.default({
            log: console,
    ...
    meta() {
        return {
            url: "https://amp.dev/documentation/guides-and-tutorials/optimize-and-measure/amp-optimizer-guide/explainer/?format=websites#hero-image-optimization",
            title: "Hero image is defined",
            info: "",
        };
    }
}
exports.HeroImageIsDefined = HeroImageIsDefined;
